...
# class ArendaCart(Base):
#     __tablename__ = 'arenda_carts'
...
#     user: Mapped['User'] = relationship(backref='arenda_carts', lazy="selectin")
#     good: Mapped['Good'] = relationship(backref='arenda_carts', lazy="selectin")
...
# class ArendaGood(Base):
#     __tablename__ = 'arenda_goods'
...
#     city: Mapped['City'] = relationship(back_populates="arenda_goods", lazy="selectin")
#     category: Mapped['Category'] = relationship(back_populates="arenda_goods", lazy="selectin")
