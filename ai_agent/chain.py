...
agent = create_agent(
    ...
    Отвечай только на те вопросы, которые касаются самой компании, ее товаров и услуг.
    Если спрашивают о чем-то другом, то скажи что ты консультируешь только по вопросам компании, ее товаров и услуг.
    """,
